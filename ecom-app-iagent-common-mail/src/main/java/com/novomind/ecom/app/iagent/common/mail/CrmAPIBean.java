...
@CustomManagedBean("CrmAPIBean")
public class CrmAPIBean implements CustomBean {
    ...
    public CrmAPIBean(App app, Logger log) {
        this.app = app;
        this.log = log;
        CRM_LINK_FORMAT = "%s";
        ...
        if (app != null) {
            ...
            if (config != null) {
                try {
                    SITE = config.getString(CrmConstants.KEY_SITE);
                    USER_KEY = config.getString(CrmConstants.KEY_USER_KEY);
                    SITE_KEY = config.getString(CrmConstants.KEY_SITE_KEY);
                    TAB_HEADING = config.getString(CrmConstants.KEY_TAB_HEADING);
                    TAB_FULLSCREEN = config.getBoolean(CrmConstants.KEY_TAB_FULLSCREEN);
